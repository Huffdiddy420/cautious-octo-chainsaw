    ...
    companion object {
        operator fun invoke(bankName: String): Int {
            val bankNameRegexIconMap = mapOf(
                Regex("Bank of America", RegexOption.IGNORE_CASE) to R.drawable.stripe_ic_bank_boa,
                Regex("Capital One", RegexOption.IGNORE_CASE) to R.drawable.stripe_ic_bank_capitalone,
                Regex("Citi", RegexOption.IGNORE_CASE) to R.drawable.stripe_ic_bank_citi,
                Regex("BBVA|COMPASS", RegexOption.IGNORE_CASE) to R.drawable.stripe_ic_bank_compass,
                Regex("MORGAN CHASE|JP MORGAN|Chase", RegexOption.IGNORE_CASE) to R.drawable.stripe_ic_bank_morganchase,
                Regex("NAVY FEDERAL CREDIT UNION", RegexOption.IGNORE_CASE) to R.drawable.stripe_ic_bank_nfcu,
                ...
                Regex("Wells Fargo", RegexOption.IGNORE_CASE) to R.drawable.stripe_ic_bank_wellsfargo
            )
