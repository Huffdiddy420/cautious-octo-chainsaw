...
class IbanConfigTest {
    private val ibanConfig = com.stripe.android.ui.core.elements.IbanConfig()
    ...
    fun `blank IBAN returns blank state`() {
        assertThat(ibanConfig.determineState(""))
            .isEqualTo(com.stripe.android.ui.core.TextFieldStateConstants.Error.Blank)
    }

    @Test
    fun `IBAN must start with valid country code`() {
        assertThat(ibanConfig.determineState("123ABC"))
            .isInstanceOf(com.stripe.android.ui.core.TextFieldStateConstants.Error.Invalid::class.java)
    ...
    fun `incomplete IBAN is in incomplete state`() {
        assertThat(ibanConfig.determineState("A"))
            .isInstanceOf(com.stripe.android.ui.core.TextFieldStateConstants.Error.Incomplete::class.java)
    ...
    fun `valid IBAN is in valid state`() {
        assertThat(ibanConfig.determineState("NL39RABO0300065264"))
            .isInstanceOf(com.stripe.android.ui.core.TextFieldStateConstants.Valid.Limitless::class.java)

        assertThat(ibanConfig.determineState("AT41190430023457320104300234573201"))
            .isInstanceOf(com.stripe.android.ui.core.TextFieldStateConstants.Valid.Full::class.java)
    }
